...
public class MovieWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.rahmat.app.cataloguemovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.rahmat.app.cataloguemovie.EXTRA_ITEM";
